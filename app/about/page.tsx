...
import { Heart, Award, Users, Anchor, ArrowRight, Star, MapPin, CheckCircle } from "lucide-react";
...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about our story, our values, and our commitment to providing exceptional waterfront retreat experiences on the Chesapeake Bay.",
};
...
const VALUES = [
  {
    ...
    description: "Every stay is treated with the same care and attention as hosting family. We believe in the power of a genuine personal touch.",
  },
  {
    num: "02",
    icon: Award,
    title: "Uncompromising Quality",
    description: "From premium linens to gourmet kitchens, every detail is curated to exceed your expectations — every single time.",
  },
  {
    num: "03",
    icon: Users,
    title: "Family Heritage",
    description: "Our properties have been lovingly maintained across generations, carrying decades of waterfront hosting experience.",
  },
  {
    num: "04",
    icon: Anchor,
    title: "Waterfront Expertise",
    description: "We know the water. From kayaks to crabbing, we help you make the most of every moment on the Chesapeake Bay.",
  },
];
...
const HERO_IMAGE   = "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=1200&q=85";
const STORY_IMAGE  = "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=900&q=85";
const STORY_IMAGE2 = "https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=900&q=85";
        ...
        <section className="relative bg-primary text-white pt-24 sm:pt-32 pb-0 overflow-hidden">
            ...
            <div className="max-w-3xl">
              ...
              <AnimateOnScroll delay={0.1}>
                <h1 className="font-serif text-4xl sm:text-5xl lg:text-7xl font-bold leading-[1.05] mb-6">
                  Waterfront Hosting
                  <span className="block text-secondary italic">With Heart.</span>
                </h1>
              </AnimateOnScroll>
              <AnimateOnScroll delay={0.2}>
                <p className="text-white/65 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl">
                  For over four decades, our family has welcomed guests to some of the most
                  breathtaking waterfront locations on the Chesapeake Bay. We don&apos;t just
                  rent properties — we share our home.
                </p>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.3}>
                <div className="flex flex-wrap gap-3 mt-8 mb-12 sm:mb-16">
                  {STATS.map(({ value, label }) => (
                    <div key={label} className="flex items-center gap-2.5 bg-white/8 border border-white/12 rounded-full px-4 py-2">
                      <span className="font-serif font-bold text-secondary text-lg leading-none">{value}</span>
          ...
          <div className="relative h-56 sm:h-72 lg:h-96 mt-4 overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 sm:left-10 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-5 py-3.5 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-semibold text-sm">Chesapeake Bay, Maryland</p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimateOnScroll>
              ...
              <blockquote className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground leading-snug italic">
                &ldquo;The best vacations are the ones where you feel completely at home — where the kayaks are ready, the kitchen is stocked, and the dock is yours at sunrise.&rdquo;
              </blockquote>
              <div className="w-12 h-0.5 bg-secondary mx-auto mt-8 mb-5" />
              <p className="text-muted-foreground text-sm font-medium">— The Harris Family</p>
            </AnimateOnScroll>
          </div>
        </section>
              ...
              <div>
                ...
                <AnimateOnScroll delay={0.1}>
                  <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-8">
                    From One Cottage
                    <span className="text-secondary italic block">to a Collection.</span>
                  </h2>
                </AnimateOnScroll>
                ...
                <div className="space-y-5 text-muted-foreground text-sm sm:text-base leading-relaxed">
                  <AnimateOnScroll delay={0.15}>
                    <p>
                      What started as a single waterfront cottage in 1984 has grown into a
                      handpicked collection of properties — each chosen for its exceptional
                      location, stunning views, and ability to create truly memorable experiences.
                    </p>
                  </AnimateOnScroll>
                  <AnimateOnScroll delay={0.2}>
                    <p>
                      Three generations later, the same spirit of warm hospitality guides
                      everything we do. We take care of every detail — from fresh linens and
                      stocked kitchens to kayaks at the dock — so you can focus entirely on
                      making memories.
                    </p>
                  </AnimateOnScroll>
                  <AnimateOnScroll delay={0.25}>
                    <p>
                      Our guests return year after year, and many have become dear friends.
                      That relationship — built on trust, transparency, and genuine care — is
                ...
                <AnimateOnScroll delay={0.3}>
                  <div className="mt-8 space-y-2.5">
                    {PROMISES.map((p) => (
                      <div key={p} className="flex items-start gap-2.5 text-sm text-foreground/70">
              ...
              <AnimateOnScroll delay={0.2} direction="right">
                <div className="relative">
                  ...
                  <div className="absolute -top-4 -right-4 bg-secondary text-primary rounded-2xl p-4 shadow-xl text-center min-w-24">
                    <p className="font-serif text-3xl font-bold leading-none">40+</p>
                    <p className="text-xs font-semibold mt-1 leading-tight">Years of<br />Hosting</p>
                  </div>
                </div>
              </AnimateOnScroll>
            ...
            <AnimateOnScroll>
              <div className="bg-muted/30 rounded-3xl p-8 sm:p-12 border border-border/50 relative overflow-hidden">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <p className="font-semibold text-foreground text-sm">A personal note</p>
                    <p className="text-muted-foreground text-xs">from the Harris family</p>
                  </div>
                </div>
                <blockquote className="font-serif text-lg sm:text-xl lg:text-2xl text-foreground leading-relaxed italic mb-8">
                  &ldquo;When you stay with us, you become part of our story. We have poured
                  our hearts into these properties so that every sunrise on the water, every
                  crab feast on the dock, every quiet evening with the family — feels like
                  it was made just for you. Thank you for choosing us.&rdquo;
                </blockquote>
                <div className="flex items-center gap-4 pt-6 border-t border-border/50">
                  ...
                  <div>
                    <p className="font-bold text-foreground text-sm">The Harris Family</p>
          ...
          <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 text-center">
            ...
            <AnimateOnScroll delay={0.1}>
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
                Your Perfect Stay
                <span className="text-secondary italic block">Awaits.</span>
              </h2>
            </AnimateOnScroll>
            <AnimateOnScroll delay={0.2}>
              <p className="text-white/60 text-sm sm:text-base mb-8 leading-relaxed">
                Browse our handpicked collection of waterfront properties and find the one
                that feels like it was made for your family.
              </p>
            </AnimateOnScroll>
            <AnimateOnScroll delay={0.25}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full border-2 border-white/25 text-white/80 hover:border-secondary hover:text-secondary text-sm font-semibold transition-all duration-200"
                >
                  Get in Touch
                </Link>
              </div>
