...
export const metadata: Metadata = {
  title: "Harriscove",
  description:
    "Browse our collection of luxury waterfront rental properties. Filter by bedrooms, guests, and price to find your perfect retreat.",
};
...
export default async function PropertiesPage({
  ...
  const [listings, { checkIn = "", checkOut = "", guests = "" }] =
    await Promise.all([getAllListings(), searchParams]);
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <p className="text-white/60 max-w-xl text-sm sm:text-base leading-relaxed">
                  Every property is handpicked for its waterfront location,
                  comfort, and character. Filter below to find your perfect
                  retreat.
                </p>
              </div>
